...
const planningEntries: PlanningEntry[] = [
  /* ── 23 avril – GMS ── */
  { id:"p1",  activity:"GMS", team:"G1", client:"Intermarche Plateau",         date:"2026-04-23", start:"05:45", title:"Ouverture magasin",       status:"done_reported"       },
  { id:"p2",  activity:"GMS", team:"G1", client:"Carrefour Palmarejo",          date:"2026-04-23", start:"06:00", title:"Nettoyage facade",         status:"done_reported"       },
  { id:"p3",  activity:"GMS", team:"G1", client:"Mini Prix Assomada",           date:"2026-04-23", start:"06:30", title:"Passage ouverture",        status:"done_missing_report" },
  { id:"p4",  activity:"GMS", team:"G2", client:"Auchan Express Mindelo",       date:"2026-04-23", start:"06:15", title:"Nettoyage premium",        status:"done_reported"       },
  { id:"p5",  activity:"GMS", team:"G2", client:"Carrefour Palmarejo",          date:"2026-04-23", start:"07:00", title:"Vitrerie principale",      status:"done_reported"       },
  { id:"p6",  activity:"GMS", team:"G2", client:"Intermarche Plateau",          date:"2026-04-23", start:"07:30", title:"Controle reserve",         status:"scheduled"           },
  { id:"p7",  activity:"GMS", team:"G3", client:"SuperSpar Praia Norte",        date:"2026-04-23", start:"06:00", title:"Ouverture Nord",           status:"done_missing_report" },
  { id:"p8",  activity:"GMS", team:"G3", client:"Auchan Express Mindelo",       date:"2026-04-23", start:"07:15", title:"Remise en etat",           status:"done_reported"       },
  { id:"p9",  activity:"GMS", team:"G3", client:"Mini Prix Assomada",           date:"2026-04-23", start:"20:30", title:"Controle facade soir",     status:"scheduled"           },
  { id:"p10", activity:"GMS", team:"G1", client:"Intermarche Plateau",          date:"2026-04-23", start:"20:30", title:"Fermeture soir",           status:"scheduled"           },
  { id:"p11", activity:"GMS", team:"G1", client:"SuperSpar Praia Norte",        date:"2026-04-23", start:"21:00", title:"Passage soiree",           status:"scheduled"           },
  { id:"p12", activity:"GMS", team:"G2", client:"Carrefour Palmarejo",          date:"2026-04-23", start:"21:15", title:"Passage soir premium",     status:"done_reported"       },
  { id:"p13", activity:"GMS", team:"G2", client:"Jumbo Fazenda",                date:"2026-04-23", start:"21:30", title:"Nettoyage intensif",       status:"scheduled"           },
  { id:"p14", activity:"GMS", team:"G3", client:"Intermarche Plateau",          date:"2026-04-23", start:"22:00", title:"Vitrerie soiree",          status:"scheduled"           },
  { id:"p15", activity:"GMS", team:"G3", client:"Carrefour Palmarejo",          date:"2026-04-23", start:"22:30", title:"Cloture caisse",           status:"scheduled"           },
  /* ── 24 avril – GMS ── */
  { id:"p16", activity:"GMS", team:"G1", client:"Carrefour Palmarejo",          date:"2026-04-24", start:"05:30", title:"Ouverture anticipee",      status:"scheduled"           },
  { id:"p17", activity:"GMS", team:"G1", client:"Jumbo Fazenda",                date:"2026-04-24", start:"06:00", title:"Nettoyage complet",        status:"scheduled"           },
  { id:"p18", activity:"GMS", team:"G2", client:"SuperSpar Praia Norte",        date:"2026-04-24", start:"06:00", title:"Remise en propre",         status:"scheduled"           },
  { id:"p19", activity:"GMS", team:"G2", client:"Intermarche Plateau",          date:"2026-04-24", start:"20:45", title:"Fermeture",                status:"scheduled"           },
  { id:"p20", activity:"GMS", team:"G3", client:"Auchan Express Mindelo",       date:"2026-04-24", start:"21:00", title:"Controle nocturne",        status:"scheduled"           },
  /* ── 25 avril – GMS ── */
  { id:"p21", activity:"GMS", team:"G1", client:"Auchan Express Mindelo",       date:"2026-04-25", start:"06:15", title:"Mise en propre",           status:"scheduled"           },
  { id:"p22", activity:"GMS", team:"G1", client:"Mini Prix Assomada",           date:"2026-04-25", start:"07:00", title:"Nettoyage vitres",         status:"scheduled"           },
  { id:"p23", activity:"GMS", team:"G2", client:"Carrefour Palmarejo",          date:"2026-04-25", start:"06:00", title:"Grande surface matin",     status:"scheduled"           },
  { id:"p24", activity:"GMS", team:"G2", client:"Jumbo Fazenda",                date:"2026-04-25", start:"06:45", title:"Entretien general",        status:"scheduled"           },
  { id:"p25", activity:"GMS", team:"G3", client:"SuperSpar Praia Norte",        date:"2026-04-25", start:"06:00", title:"Passage Nord",             status:"scheduled"           },
  { id:"p26", activity:"GMS", team:"G3", client:"Intermarche Plateau",          date:"2026-04-25", start:"20:30", title:"Fermeture vendredi",       status:"scheduled"           },
  /* ── 26 avril – GMS ── */
  { id:"p27", activity:"GMS", team:"G2", client:"Carrefour Palmarejo",          date:"2026-04-26", start:"21:00", title:"Renfort samedi soir",      status:"scheduled"           },
  { id:"p28", activity:"GMS", team:"G1", client:"SuperSpar Praia Norte",        date:"2026-04-26", start:"21:30", title:"Cloture semaine",          status:"scheduled"           },
  { id:"p29", activity:"GMS", team:"G3", client:"Jumbo Fazenda",                date:"2026-04-26", start:"20:00", title:"Nettoyage weekend",        status:"scheduled"           },
  /* ── Semaines passées – GMS ── */
  { id:"p30", activity:"GMS", team:"G1", client:"Intermarche Plateau",          date:"2026-04-20", start:"21:00", title:"Cloture lundi",            status:"done_reported"       },
  { id:"p31", activity:"GMS", team:"G2", client:"Carrefour Palmarejo",          date:"2026-04-21", start:"06:15", title:"Ouverture mardi",          status:"done_missing_report" },
  { id:"p32", activity:"GMS", team:"G3", client:"Auchan Express Mindelo",       date:"2026-04-22", start:"07:00", title:"Mercredi matin",           status:"done_reported"       },
  /* ── 23 avril – Solaire ── */
  { id:"p33", activity:"Solaire", team:"S1", client:"Hotel Atlantico Resort",   date:"2026-04-23", start:"08:00", title:"Inspection toiture A",     status:"done_reported"       },
  { id:"p34", activity:"Solaire", team:"S1", client:"Hotel Atlantico Resort",   date:"2026-04-23", start:"09:30", title:"Maintenance preventive",   status:"done_reported"       },
  { id:"p35", activity:"Solaire", team:"S1", client:"Residences Salinas",       date:"2026-04-23", start:"11:00", title:"Nettoyage panneaux",       status:"scheduled"           },
  { id:"p36", activity:"Solaire", team:"S2", client:"Residences Salinas",       date:"2026-04-23", start:"08:30", title:"Controle onduleur",        status:"done_missing_report" },
  { id:"p37", activity:"Solaire", team:"S2", client:"Parque Solar Mindelo",     date:"2026-04-23", start:"10:00", title:"Suivi production",         status:"done_reported"       },
  { id:"p38", activity:"Solaire", team:"S2", client:"Hotel Atlantico Resort",   date:"2026-04-23", start:"13:00", title:"Verification EMS",         status:"scheduled"           },
  { id:"p39", activity:"Solaire", team:"S3", client:"Parque Solar Mindelo",     date:"2026-04-23", start:"08:00", title:"Inspection reseau DC",     status:"done_reported"       },
  { id:"p40", activity:"Solaire", team:"S3", client:"Complexe Touristique Sal", date:"2026-04-23", start:"09:00", title:"Controle batteries",       status:"done_reported"       },
  { id:"p41", activity:"Solaire", team:"S3", client:"Residences Salinas",       date:"2026-04-23", start:"14:00", title:"Bilan mensuel",            status:"scheduled"           },
  /* ── 24-29 avril – Solaire ── */
  { id:"p42", activity:"Solaire", team:"S1", client:"Complexe Touristique Sal", date:"2026-04-24", start:"08:00", title:"Maintenance curative",     status:"scheduled"           },
  { id:"p43", activity:"Solaire", team:"S1", client:"Parque Solar Mindelo",     date:"2026-04-24", start:"10:00", title:"Remplacement fusible",     status:"scheduled"           },
  { id:"p44", activity:"Solaire", team:"S2", client:"Hotel Atlantico Resort",   date:"2026-04-24", start:"09:00", title:"Inspection onduleur",      status:"scheduled"           },
  { id:"p45", activity:"Solaire", team:"S2", client:"Complexe Touristique Sal", date:"2026-04-25", start:"08:30", title:"Suivi production",         status:"scheduled"           },
  { id:"p46", activity:"Solaire", team:"S3", client:"Residences Salinas",       date:"2026-04-25", start:"09:00", title:"Nettoyage integral",       status:"scheduled"           },
  { id:"p47", activity:"Solaire", team:"S3", client:"Parque Solar Mindelo",     date:"2026-04-26", start:"08:00", title:"Controle capteurs",        status:"scheduled"           },
  { id:"p48", activity:"Solaire", team:"S1", client:"Hotel Atlantico Resort",   date:"2026-04-29", start:"08:00", title:"Inspection mensuelle",     status:"scheduled"           },
  { id:"p49", activity:"Solaire", team:"S2", client:"Residences Salinas",       date:"2026-04-29", start:"09:30", title:"Verification cablage",     status:"scheduled"           },
  { id:"p50", activity:"Solaire", team:"S3", client:"Complexe Touristique Sal", date:"2026-04-29", start:"09:00", title:"Monitoring",               status:"scheduled"           },
  /* ── Semaines passées – Solaire ── */
  { id:"p51", activity:"Solaire", team:"S1", client:"Residences Salinas",       date:"2026-04-18", start:"11:00", title:"Controle production",      status:"done_reported"       },
  { id:"p52", activity:"Solaire", team:"S2", client:"Hotel Atlantico Resort",   date:"2026-04-19", start:"08:30", title:"Verification EMS",         status:"done_missing_report" },
  { id:"p53", activity:"Solaire", team:"S3", client:"Parque Solar Mindelo",     date:"2026-04-20", start:"09:00", title:"Bilan hebdo",              status:"done_reported"       },
  { id:"p54", activity:"Solaire", team:"S1", client:"Complexe Touristique Sal", date:"2026-04-21", start:"08:00", title:"Maintenance preventive",   status:"done_reported"       },
  { id:"p55", activity:"Solaire", team:"S2", client:"Parque Solar Mindelo",     date:"2026-04-22", start:"10:00", title:"Nettoyage complet",        status:"done_missing_report" },
];
